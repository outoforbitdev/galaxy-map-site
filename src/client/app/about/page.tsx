export default function About() {
  return(
    <div>
      <h3>What this is</h3>
      <p>
        This is a map of the systems in the Star Wars galaxy and the 
        hyperlanes that connect them. It’s meant as a way to explore the
        galaxy.
      </p>
      ...
      <p>
        ...
        my attempt to make a detailed map with all the features I always
        wanted.
      </p>
      ...
      <p>
        The UI for this was built from the ground up as an svg in React using Next.js.
      </p>
